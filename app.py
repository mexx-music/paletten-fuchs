...
# ---------- Getränke-Presets 20..26 (Front → Heck)
# 1 = 1 quer mittig, 2 = 2 quer nebeneinander, 3 = 3 längs
PRESETS_GETRAENKE = {
    20: [1,2,1,2,1,2,1,2,2],            # 20 = (1+2)*4 + 2
    21: [1,2,1,2,1,2,1,2,1,2,1],        # 21 = (1+2)*7
    22: [1,2,1,2,1,2,1,2,1,2,1,1],      # 22 = 21 + 1
    23: [1,2,1,2,1,2,1,2,1,2,2],        # 23 = 21 + 2
    24: [1,2,1,2,1,2,1,2,1,2,1,2],      # 24 = (1+2)*8
    25: [1,2,1,2,1,2,1,2,1,2,1,2,1],    # 25 = 24 + 1
    26: [1,2,1,2,1,2,1,2,1,2,1,2,2],    # 26 = 24 + 2
}
